...
| Folder | Host shape |
| --- | --- |
| [`NavigationViewHost/Minimal`](NavigationViewHost/Minimal) | Smallest wiring that makes the feature work: two thin adapters and one presenter |
...
| [`MockAnswers`](MockAnswers) | Scripted AI answers for demo and QA builds, with no backend |
